...
const marketPrices = [
  ...
  { name: "Onions", price: "₹25/kg", trend: "-2%", status: "stable", change: "down" },
  { name: "Potatoes", price: "₹30/kg", trend: "+8%", status: "high", change: "up" },
  { name: "Carrots", price: "₹35/kg", trend: "+3%", status: "stable", change: "up" },
  { name: "Wheat", price: "₹22/kg", trend: "-1%", status: "stable", change: "down" },
]

const myProducts = [
  { name: "Organic Tomatoes", stock: "50 kg", price: "₹45/kg", verified: true, sold: 35, total: 50 },
  { name: "Fresh Onions", stock: "100 kg", price: "₹28/kg", verified: true, sold: 78, total: 100 },
  { name: "Baby Carrots", stock: "25 kg", price: "₹40/kg", verified: false, sold: 12, total: 25 },
]
